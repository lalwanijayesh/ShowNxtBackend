...
const getApplicationById = async (application_id) => {
    var res = await db.query(`SELECT application_id, profile_id, school_id, position_id 
...
const getNextApplicationByCoach = async (coachId) => {
    var res = await db.query(
        `SELECT application_id, profile_id, school_id, position_id 
                FROM application 
...
const getApplicationByProfile = async (profileId) => {
    var res = await db.query(`SELECT application_id, profile_id, school_id, position_id 
                                    FROM application WHERE profile_id= $1`,
        [profileId]);
